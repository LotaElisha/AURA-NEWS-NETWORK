  ...
  return (
    <div className="flex h-screen bg-zinc-950 overflow-hidden text-zinc-100">
      ...
      <main className="flex-1 flex flex-col relative">
        ...
        {headlines.some(h => h.source === "System Alert" || h.title.includes("Demo Mode") || h.title.includes("ANGALIZO:")) && (
          <div className="bg-amber-950/40 border-b border-amber-900/40 px-8 py-2.5 flex items-center justify-between text-xs text-amber-200 backdrop-blur-md z-10">
            <div className="flex items-center gap-2">
              ...
              <span><strong>Demo Mode Active:</strong> Shared Gemini API Quota exceeded. Please configure your personal Gemini API Key in the top right to restore live Google News searches.</span>
            </div>
            <button
              onClick={() => window.aistudio?.openSelectKey()}
